...
_sage_const_10 = Integer(10); _sage_const_4 = Integer(4); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)
import json

MAX_DIM = _sage_const_10 
MAX_DEGREE = _sage_const_10 
MAX_NUM_HYPERSURFACES = _sage_const_4 
